...
export function TextSuggestions({ onSelectSuggestion, language }) {
  ...
  const suggestions = {
    ...
    ur: [
      "میرا دن بہت اچھا گزر رہا ہے!",
      "یہ پروڈکٹ مایوس کن ہے۔",
      "آج کا موسم ٹھیک ہے۔",
      "میں سروس سے بہت خوش ہوں!",
      "میں ابھی کافی مایوس محسوس کر رہا ہوں۔",
    ],
    ar: [
      "يومي رائع جدًا!",
      "هذا المنتج مخيب للآمال.",
      "الطقس اليوم جيد.",
      "أنا سعيد جدًا بالخدمة!",
      "أشعر بالإحباط الشديد الآن.",
    ],
  }
